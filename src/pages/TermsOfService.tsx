    ...
    <div className="min-h-screen">
      ...
      <main className="pt-32 pb-16 px-4 md:px-8 max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4">3. Account Registration and Use</h2>
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4">11. Service Modifications</h2>
